...
public class ReviewQuestionJdbcRepository {
  ...
  public void batchInsert(List<ReviewQuestion> reviewQuestions) {
    ...
    jdbcTemplate.batchUpdate(sql, new BatchPreparedStatementSetter() {
      ...
      public void setValues(PreparedStatement ps, int i) throws SQLException {
        ReviewQuestion reviewQuestion = reviewQuestions.get(i);
        ps.setLong(1, reviewQuestion.getReviewForm().getId());
        ps.setLong(2, reviewQuestion.getQuestion().getId());
